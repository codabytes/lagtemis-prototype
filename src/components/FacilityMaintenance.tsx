                ...
                <tr key={log.id} className="hover:bg-slate-50 transition-colors">
                  <td className="px-6 py-4">
                    <div className="flex items-center gap-3">
                      ...
                      <span className="text-sm font-bold text-slate-900">{log.facilityName}</span>
                    </div>
                  </td>
                  <td className="px-6 py-4">
                    <span className={`px-2 py-1 rounded text-[10px] font-bold uppercase tracking-wider flex items-center gap-1 w-fit ${
                      ...
                      {log.maintenanceType === 'Preventive' && <CheckCircle2 size={10} />}
                      {log.maintenanceType === 'Corrective' && <AlertTriangle size={10} />}
                      {log.maintenanceType === 'Predictive' && <Activity size={10} />}
                      {log.maintenanceType}
                    </span>
                  </td>
                  <td className="px-6 py-4">
                    <p className="text-sm text-slate-600 line-clamp-1">{log.workPerformed}</p>
                  </td>
                  <td className="px-6 py-4">
